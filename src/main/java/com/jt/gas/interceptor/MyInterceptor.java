package com.jt.gas.interceptor;




import com.jt.gas.entity.GasUser;
...
public class MyInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (path.indexOf("public") != -1 || "/error".equals(path)){//访问的是公共路径，允许
            ...
            //查询session是否有user对象
            GasUser user = (GasUser)request.getSession().getAttribute("user");
    ...
    private boolean checkLogin(HttpServletRequest request){
        ...
        if (cookies != null){
            ...
            //查询数据库
            GasUser user = userServiceImpl.finUserByAccount(account);
            if (user != null){
